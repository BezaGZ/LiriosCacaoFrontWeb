...
const FRUTAS: Fruta[] = [
  { id: 'fru_manzana',   nombre: 'Manzana',   imagenBase: 'assets/chocofruta/manzana_tradicional.png',  disponible: true },
  { id: 'fru_fresa',     nombre: 'Fresa',     imagenBase: 'assets/chocofruta/fresa_tradicional.png',    disponible: true },
  { id: 'fru_pina',      nombre: 'Piña',      imagenBase: 'assets/chocofruta/pina_tradicional.png',     disponible: true },
  { id: 'fru_melon',     nombre: 'Melón',     imagenBase: 'assets/chocofruta/melon_tradicional.png',    disponible: true },
  { id: 'fru_melocoton', nombre: 'Melocotón', imagenBase: 'assets/chocofruta/melocoton_tradicional.png',disponible: true },
  { id: 'fru_banano',    nombre: 'Banano',    imagenBase: 'assets/chocofruta/banano_tradicional.png',   disponible: true },
  { id: 'fru_sandia',    nombre: 'Sandía',    imagenBase: 'assets/chocofruta/sandia_tradicional.png',   disponible: true },
  { id: 'fru_uva',       nombre: 'Uva',       imagenBase: 'assets/chocofruta/uva_tradicional.png',      disponible: true },
];
...
export const CHOCOFRUTA_SEED: CatalogoChocofruta = {
  ...
  toppings: TOPPINGS,
  reglas: {
    baseConHastaUnTopping: 7,        // 0 o 1 topping incluido
    recargoChocolateNoTradicional: 1,// ≈ total 8 si no es tradicional
    recargoToppingExtra: 2,          // por cada topping adicional
    recargoDobleChocolate: 2,        // doble chocolate
  },
};
